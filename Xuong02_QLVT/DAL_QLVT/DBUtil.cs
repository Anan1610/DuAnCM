...
namespace DAL_QLVT
{
    public class DBUtil
    {
        public static string connString = @"Data Source=PHAMTRANANAN\SQLEXPRESS01;Initial Catalog=QuanLyVatTuXayDung;Integrated Security=True;Trust Server Certificate=True";
